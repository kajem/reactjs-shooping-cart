                        ...
                        <div className="card-content mb-2 mt-2">
                            ...
                            <div className="row mb-0">
                                    <div className="col-sm-4">
                                        <Link to="/reactjs-shooping-cart" onClick={()=>{this.handleClick(item.id)}} className="add-to-cart"><img src="/reactjs-shooping-cart/cart-add-icon.png" alt="Add to cart" /></Link>
                                    </div>
